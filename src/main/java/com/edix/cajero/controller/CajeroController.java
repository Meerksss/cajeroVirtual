...
import com.edix.cajero.modelo.dao.CuentaDao;
import com.edix.cajero.modelo.dao.MovimientoDao;
...
public class CajeroController {
	...
	@Autowired
	private CuentaDao icuen;
	@Autowired
	private MovimientoDao imov;
	...
	public String extraerDinero(Model model) {
		...
		if (cuenta.getTipoCuenta().equals("ahorro")) {
			...
			lista=imov.listaUltimosMovimientosByidCuenta(cuenta.getIdCuenta());
	...
	public String verMovimientos(Model model) {
		Cuenta cuenta=(Cuenta)misesion.getAttribute("cuenta");
		model.addAttribute("listamovimientos", imov.listaUltimosMovimientosByidCuenta(cuenta.getIdCuenta()));
		model.addAttribute("Cuenta", cuenta);
